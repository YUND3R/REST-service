...
async def analyze(
    ...
    if cached is not None:
        ...
        webhook_body: dict[str, Any] = {"student_id": str(body.student_id), "analysis": cached}
        ...
        await _persist_analysis_row(student_uuid, body.task_description, body.code, cached)
